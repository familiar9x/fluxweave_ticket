...
CREATE OR REPLACE FUNCTION sfadi001s15110 ( l_inKkSakuseiDt varchar(20), l_inDenbunMeisaiNo numeric ) RETURNS integer AS $body$
DECLARE
...
-- *====================================================================
	-- 本SPのID
	SP_ID				CONSTANT varchar(20) := 'SFADI001S15110';
	-- ユーザID
...
LANGUAGE PLPGSQL
;
-- REVOKE ALL ON FUNCTION sfadi001s15110 ( l_inKkSakuseiDt varchar(20), l_inDenbunMeisaiNo numeric ) FROM PUBLIC;
