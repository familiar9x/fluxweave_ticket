...
""",
    ...
    'bcgy-8835': {
        ...
        'tests': [
            {
                'description': 'Redemption schedule table creation - with real data',
                'postgres_sql': """
DO $$ 
DECLARE 
    v_code integer;
...
END $$;
""",
                'expected': [0, 2, 99],  # 0=SUCCESS, 2=NODATA, 99=May timeout with complex data
                'allow_timeout': True
            }
        ]
    },
...
END $$;
""",
                'expected': [0, 2, 99],  # 0=SUCCESS, 2=NODATA, 99=Error in dependent function
                'allow_timeout': True
            }
        ]
    }
