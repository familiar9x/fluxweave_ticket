...
CREATE OR REPLACE FUNCTION sfip931500121 ( l_inUserId text          --	ユーザＩＤ		
...
--********************************************************************************************************************
-- * 元利金手数料一括分仮受金明細表
-- * 画面で指定した対象月について、銘柄単位で振替額および仮受金残高を出力する。
-- *
-- * @author	ASK
-- *
...
--==============================================================================
  ...
  PROGRAM_ID    CONSTANT varchar(30) := 'SFIP931500121';  -- プログラムＩＤ
--=======================================================================================================*
-- * 変数定義
-- *=======================================================================================================
...
LANGUAGE PLPGSQL
;
-- REVOKE ALL ON FUNCTION sfip931500121 ( l_inUserId text , l_inItakuKaishaCd text , l_inKijun_Ym text , l_inChohyo_Kbn text , l_outErrMsg OUT text , OUT extra_param numeric) FROM PUBLIC;
