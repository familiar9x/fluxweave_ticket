...
CREATE OR REPLACE FUNCTION sfiph001k00r31 () RETURNS numeric AS $body$
DECLARE
...
--*
--* @author ASK
--* @version $Id: SFIPH001K00R31.sql,v 1.3 2007/04/02 05:41:01 kuwabara Exp $
--*
--***************************************************************************
--* ログ　:
--* 　　　日付  開発者名    目的
...
--
	...
	--                  定数定義                                                    
	--==============================================================================
	C_FUNCTION_ID CONSTANT text := 'SFIPH001K00R31'; -- ファンクションＩＤ
	--==============================================================================
	--                  変数定義                                                    
	--==============================================================================
...
BEGIN
	...
	LOOP
		...
		-- 帳票作成ＳＰ（子ＳＰ）
		gReturnCd := SFIPH001K00R31_01(recMeisai.KAIIN_ID);
		-- エラーの場合
...
LANGUAGE PLPGSQL
;
-- REVOKE ALL ON FUNCTION sfiph001k00r31 () FROM PUBLIC;