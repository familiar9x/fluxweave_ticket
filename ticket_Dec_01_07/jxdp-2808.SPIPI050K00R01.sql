...
;
	...
	v_item.l_inItem012 := recMeisai.gTsukaNm;  -- 通貨名称
	v_item.l_inItem013 := recMeisai.gIsinCd;  -- ISINコード
	v_item.l_inItem014 := recMeisai.gKokyakuMgrRnm;  -- 対顧用銘柄略称
	v_item.l_inItem015 := recMeisai.gPreMnthZndk;  -- 前月末残高
	v_item.l_inItem016 := gMnthZndk;  -- 当月末残高
	v_item.l_inItem017 := recMeisai.gNknKknKngk;  -- 当月入金高_基金受入高
	v_item.l_inItem018 := recMeisai.gNknOtherKngk;  -- 当月入金高_その他
	v_item.l_inItem019 := recMeisai.gSknGnrKngk;  -- 当月出金高_元利金支払高
	v_item.l_inItem020 := recMeisai.gSknTsrKngk;  -- 当月出金高_同手数料
	v_item.l_inItem021 := recMeisai.gSknKzKngk;  -- 当月出金高_国税
	v_item.l_inItem022 := recMeisai.gSknKknKngk;  -- 当月出金高_基金返戻金
	v_item.l_inItem023 := recMeisai.gSknOtherKngk;  -- 当月出金高_その他
	v_item.l_inItem024 := recMeisai.gTsukaCd;  -- 通貨コード
	v_item.l_inItem026 := recMeisai.gKozaTenCd;  -- 口座店コード
	v_item.l_inItem027 := trim(both recMeisai.gKozaTenCifcd);  -- 口座店ＣＩＦコード
	v_item.l_inItem028 := gRedOptionFlg;  -- レッドプロジェクトオプションフラグ
