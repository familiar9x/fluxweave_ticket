...
BEGIN
	...
	FOR recMeisai IN curMeisai LOOP
		...
		v_item.l_inItem018 := DVP_KBN_TITLE;
		...
		v_item.l_inItem002 := l_inGyomuYmd;
		v_item.l_inItem003 := gItakuKaishaRnm;
		v_item.l_inItem004 := recMeisai.SHR_YMD;
		v_item.l_inItem005 := recMeisai.DVP_NM;
		v_item.l_inItem006 := recMeisai.TSUKA_NM;
		v_item.l_inItem007 := recMeisai.MGR_CD;
		v_item.l_inItem008 := recMeisai.ISIN_CD;
		v_item.l_inItem009 := recMeisai.MGR_NM;
		v_item.l_inItem010 := recMeisai.GNR_ZNDK;
		v_item.l_inItem011 := recMeisai.SHOKAN_SEIKYU_KNGK;
		v_item.l_inItem012 := recMeisai.GZEIHIKI_BEF_CHOKYU_KNGK;
		v_item.l_inItem013 := recMeisai.GZEI_KNGK;
		v_item.l_inItem014 := recMeisai.GZEIHIKI_AFT_CHOKYU_KNGK;
		v_item.l_inItem015 := recMeisai.SHR_KNGK;
		v_item.l_inItem016 := C_REPORT_ID;
		v_item.l_inItem017 := gKngkFormat;
		v_item.l_inItem019 := recMeisai.TSUKA_CD;
		v_item.l_inItem020 := recMeisai.DVP_KBN;
	...
	IF gSeqNo = 0 THEN
		...
		v_item.l_inItem002 := l_inGyomuYmd;
		v_item.l_inItem003 := gItakuKaishaRnm;
		v_item.l_inItem004 := l_inKessaiYmdF;
		v_item.l_inItem016 := C_REPORT_ID;
		v_item.l_inItem021 := l_inKessaiYmdT;
